...
@Component
public class AttractionForUserQueryHandler
        implements Command.Handler<AttractionForUserQuery, List<AttractionForUserDto>> {
    ...
    private AttractionForUserDto mapToDto(AttractionForUser attractionForUser) {
        return new AttractionForUserDto(attractionForUser.getId(), attractionForUser.getAttractionName(),
                attractionForUser.getAttractionDescription(), attractionForUser.getAttractionLogo(),
                generateListOfTags(attractionForUser), attractionForUser.getTour());
    }
